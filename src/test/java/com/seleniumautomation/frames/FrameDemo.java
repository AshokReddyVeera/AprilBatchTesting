...
public class FrameDemo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("email")).sendKeys("xxx@yyy.zzz"); // child frame

		driver.switchTo().defaultContent();//directly came to main page

		driver.findElement(By.xpath("//*[@data-icon='home']")).click(); //any-tagname[@attribute='value']
